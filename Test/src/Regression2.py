...
# The data is the advertising dollars spent on a single product for different media in a single market
...
# Panda is build on top of NunPy, thus X can be a pandas DataFrame and y a pandas Series
...
# In in the linear formula it would be something like this
...
# Evaluation metrics for classification problems, such as accuracy, are not useful for regrression problems.
...
true = [100, 50, 30, 20]
pred = [90, 50, 50, 30]
# The error here are 10 (100-90), 0 (550-50), 20 (50-30) and 10 (30-20)
...
# Calculate the Mean Square Error (MSE) is the mean of the squared errors
# By hand
